      ...
      <div className="shell py-24 md:py-32">
        <Reveal>
          ...
          <p className="mt-8 max-w-2xl leading-relaxed text-ink/60">
            The full specification covers the SEP stack MACH composes, the
            settlement engine&rsquo;s trust boundaries, the SEP-59 verification
            path, the Soroban contract interface, and the failure modes we
            design against.
          </p>
